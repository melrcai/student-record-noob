...
`students.txt` file may not display formatted correctly when viewed. however, when the program is executed in my terminal, the output prints as expected lol.

*personal note:* idk why, but one thing im sure of: im tired asf. i rlly need to sleep coz i do have my mrning class tmr for 2 subjects. i'm gonna fix it tmr when i do have time left (i hope so coz i have my last subject, and we have 4 hrs vacant b4 that AHHH ts is killin' me, I HATE F2F BTW). anw, i'm having stiff necks XD.

hoping i'll wake up by 5 am tmr to do sum other thingzz.
